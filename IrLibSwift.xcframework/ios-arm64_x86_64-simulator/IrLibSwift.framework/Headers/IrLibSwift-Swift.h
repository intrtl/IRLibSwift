...
@protocol IRDataManagerObjcProtocol
...
- (void)startAnalytics;
- (void)fetchSettingsAndRoutesWithCompletionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
...
@interface IRDataManager : NSObject <IRDataManagerObjcProtocol>
...
- (void)authorizeOnAllAvailablePortalsWithLogin:(NSString * _Nonnull)login password:(NSString * _Nonnull)password externalUserId:(NSString * _Nullable)externalUserId completionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
@end
