...
- (void)fetchSettingsWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
...
- (UIViewController * _Nonnull)searchControllerWithResultsOutput:(id <StoresModuleOutput> _Nonnull)resultsOutput SWIFT_WARN_UNUSED_RESULT;
...
@protocol StoreDetailsOutput
- (void)didTriggerOpenOsaReportForTaskWithId:(NSString * _Nullable)taskId matrixType:(NSString * _Nullable)matrixType;
